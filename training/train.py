...
if __name__ == "__main__":
    ...
    print(f'{os.environ["SM_CHANNEL_TRAIN"]} content: {os.listdir(os.environ["SM_CHANNEL_TRAIN"])}')
    train_ds = Food101(root=os.environ["SM_CHANNEL_TRAIN"], split='train', transform=preprocessor)
    test_ds = Food101(root=os.environ["SM_CHANNEL_TRAIN"], split='test', transform=preprocessor)
